		...
		<div class="single">
				<div class="box_wrapper"><h1>Chevrolet Cruze : (Rs  13.38 - 14.2 Lakh*)</h1></div>
				    <div class="single-top"> 	
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/cr-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/cr-2.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/cr-3.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/cr-4.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/cr-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/cr-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/cr-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/cr-4.jpg" alt=" " /></a></li>
						...
						<div class="grid span_2_of_3">
                            ...
                            <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                                   ...
                                   <tbody class="text-center">
                                       <tr>
                                           <td>Transmission : Automatic/Manual</td>
                                           <td>ABS : Yes</td>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">CRUZE highlights</th>
                            </tr>
                        </thead>
