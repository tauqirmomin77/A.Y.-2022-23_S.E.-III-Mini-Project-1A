		    ...
		    <div class="menu-main">
			   ...
			   <ul class="dc_css3_menu">
                    ...
                    <li><a href="services.php">Brands</a></li>
                     ...
                     <li><a href="index.html">Need loan?</a></li>
	...
	<div class="wrap">
        ...
        <form class="text-center" action="booking.php" method="post" >
           ...
           <div>
             ...
             <div><br>
                <button type="submit" name="book" class="btn btn-warning" value="book">book Test drive</button>
                <p>
                	OR
                </p>
                <button type="submit" class="btn btn-warning" > <a href="payment.html">Make Payment</a></button>
	   ...
	   <div class="footer-top">				
				...
				<div class="col_1_of_5 span_1_of_5">
					<div class="footer-grid twitts">
						...
						<p>914465488611</p>
						<span>support@motorhubs.com</span>
					</div>
				</div>
				<div class="clear"></div>
		</div>
