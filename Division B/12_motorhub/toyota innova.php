...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Toyota Innova Crysta  : (Rs  13.52 - 22.15 Lakh*)</h1></div>
		  				...
		  				<div class="lsidebar span_1_of_s">
							   ...
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="images/in-1.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/in-2.jpg" alt=" " height=210px width=560px/></a>
									<a href="#" target="_blank"><img src="images/in-3.jpg" alt=" " height=210px width=560px/></a>					
									<a href="#" target="_blank"><img src="images/in-4.jpg" alt=" " height=210px width=560px/></a>
									
								</div>
								<ul class="pagination">
									<li><a href="#"><img src="images/in-1.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/in-2.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/in-3.jpg" alt=" " /></a></li>
									<li><a href="#"><img src="images/in-4.jpg" alt=" " /></a></li>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        <thead>
                            <tr>
                                <th class="text-center" style="font-family: broadway; ">INNOVA CRYSTA highlights</th>
                            </tr>
                        </thead>
...
Toyota has confirmed the waiting period for the Innova Crysta currently ranges between 4-6 weeks, even with its production plant working at 95 per cent of its capacity. Click here for more details.
